                                ...
                                <div class="setting-panel">
                                    <div class="info_info">
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <ul>
                                                        <li>{{ trans('profile.username') }}</li>
                                                        <li id="newname"><span>{{ $info->name }}</span>&nbsp;&nbsp;<i id="setName"  class="glyphicon glyphicon-pencil"></i></li>
                                                    </ul>
                                                </td>
                                                <td>
                                                    <ul>
                                                        <li>{{ trans('profile.email') }}</li>
                                                        <li><span> {{ $info->email }}</span>&nbsp;&nbsp;<i id="setEmail"  class="glyphicon glyphicon-pencil"></i></li>
                                                    </ul>
                                                </td>
                                                <td>
                                                    <ul>
                                                        <li>{{ trans('profile.password') }}</li>
                                                        <li><span>*******</span>&nbsp;&nbsp;<i  data-toggle="modal" data-target="#setPass" class="glyphicon glyphicon-pencil"></i></li>
                                                    </ul>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <ul>
                                                        <li>{{ trans('profile.pin') }}</li>
                                                        <li><span>*******</span>&nbsp;&nbsp;<i class="glyphicon glyphicon-pencil"></i></li>
                                                    </ul>
                                                </td>
                                                {{--<td>
                                                    <ul>
                                                        <li>Api keys</li>
                                                        <li><span>*******</span>&nbsp;&nbsp;<i id="setPinClick" class="glyphicon glyphicon-pencil"></i></li>
                                                    </ul>
                                                </td>--}}
                                                <td>
                                                    <ul>
                                                        <li>{{ trans('profile.userid') }}</li>
                                                        <li><span> {{ $info->id }}</span></li>
                                                    </ul>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <ul>
                                                        <li>{{ trans('profile.loginIp') }}</li>
                                                        <li><span>{{ $info->loginInfo->last_login_ip }}</span></li>
                                                    </ul>
                                                </td>
                                                <td>
                                                    <ul>
                                                        <li>{{ trans('profile.lastLogin') }}</li>
                                                        <li><span>{{ $info->loginInfo->last_login_time }}</span></li>
                                                    </ul>
                                                </td>
                                                <td>
                                                    <ul>
                                                        <li>{{ trans('profile.register') }}</li>
                                                        <li><span>{{ $info->created_at }}</span></li>
                                                    </ul>
                                                </td>
                                            </tr>
                                            </tbody>
                                    ...
                                    <div class="safe-item ID_card">
                                        ...
                                        @if($info->is_certification == 1)
                                            <a href="">待审核</a>
                                        @elseif($info->is_certification == 0)
                                            <a href="">未上传审核</a>
